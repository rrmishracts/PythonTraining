...
def insertPupper(pupper):
    insert_sql = "insert into pythontest.pupper (name,sex,weight,color,date_of_brith, breed_id) values (%s,%s,%s,%s,%s,%s)"
    data = (pupper.name, pupper.sex, pupper.weight,pupper.color,pupper.date_of_brith, pupper.breed_id)
